 ...
 */
package com.vutuananh.changeurltobutton.view.adapter;
...
public class SingleTypeAdapter<T> extends BaseViewAdapter<T> {
    ...
    public SingleTypeAdapter(Context context, List<T> collection, int layoutRes) {
        super(context);
    ...
    public BindingViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new BindingViewHolder(DataBindingUtil.inflate(mLayoutInflater, getLayoutRes(),
            parent, false));
    }
    ...
    public void setList(List<T> viewModels) {
